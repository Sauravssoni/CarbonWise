...
const replacements = [
  ...
  { regex: /100% app availability/gi, replace: 'core experience remains functional without an AI key' },
  ...
  { regex: /Express appends standard, robust security layers:/gi, replace: 'Vercel appends standard, robust security layers:' },
  { regex: /An Express\.ts backend bound natively with Vite/gi, replace: 'A Vercel Serverless backend bound natively with Vite' }
];
